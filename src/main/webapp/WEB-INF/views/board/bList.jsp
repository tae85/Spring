...
<body bgcolor="#ffefd5">
	...
	<table>
		...
		<c:if test="${listCount ne 0 }">
			<c:forEach var="v" items="${list }" varStatus="s">
			<tr>
				<td align="center">${s.count }</td>
				<td align="left">
					<a href="bDetail.do?board_num=${v.board_num }&page=${currentPage}">
						&nbsp;${v.board_title }
					</a>
				</td>
				<td align="center">${v.board_writer }</td>
				<td align="center">${v.regDate }</td>
				<td align="center">${v.read_count }</td>
			</tr>
			</c:forEach>
		</c:if>
		<!-- 앞 페이지 번호 처리 -->
